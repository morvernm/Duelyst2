...
public class OrderedCardLoader {
	...
	public static List<Card> getPlayer1Cards() {
		...
		cardsInDeck.add(BasicObjectBuilders.loadCard(StaticConfFiles.c_sundrop_elixir, 18, Sundrop.class));
	...
	public static List<Card> getPlayer2Cards() {
		...
		cardsInDeck.add(BasicObjectBuilders.loadCard(StaticConfFiles.c_staff_of_ykir, 22, Staff.class));
		...
		cardsInDeck.add(BasicObjectBuilders.loadCard(StaticConfFiles.c_entropic_decay, 27, EntropicDecay.class));
		...
		cardsInDeck.add(BasicObjectBuilders.loadCard(StaticConfFiles.c_staff_of_ykir, 32, Staff.class));
		...
		cardsInDeck.add(BasicObjectBuilders.loadCard(StaticConfFiles.c_entropic_decay, 37, EntropicDecay.class));
